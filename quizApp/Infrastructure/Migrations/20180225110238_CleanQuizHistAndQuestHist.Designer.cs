...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20180225110238_CleanQuizHistAndQuestHist")]
    partial class CleanQuizHistAndQuestHist
    {
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Student", b =>
                {
                    ...
                    b.Property<int>("StudentQuizHistId");

                    b.HasKey("Id");

                    b.HasIndex("StudentQuestionHistId");

                    b.HasIndex("StudentQuizHistId");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Student", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.StudentQuizHist", "StudentQuizHist")
                        .WithMany()
                        .HasForeignKey("StudentQuizHistId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
